...
const Category = () => {
  ...
  const getDataForTable = useCallback(async () => {
    ...
    const { data } = await AxiosHelper.getData("category-datatable", param);
  ...
  const dropList = [
    ...
    },
    {
      ...
      onClick: (event) => {
        ...
        navigate(`/admin/category/edit/${data.slug}`);
      },
    },
    {
      name: "Delete",
                                ...
                                >
                                  ...
                                  {row?.parent ? (
                                    <span>
                                      ...
                                      {ucFirst(row?.parent?.name)}
                                    </span>
                                  ) : null}
                                  {row?.parent?.superCategory ? (
                                    <span>
                                      <i
                                        style={{ fontSize: "14px" }}
                                        className="fas mx-1"
