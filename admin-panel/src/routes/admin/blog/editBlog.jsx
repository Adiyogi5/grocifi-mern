...
import { fetchBlogAuthor, fetchCategories, fetchBlogBySlug} from '../../../helper/ApiService';
...
const editBlog = () => {
    ...
    const fetchData = useCallback(async () => {
        try {
            const [blog, author ,categories] = await Promise.all([
            ...
            if (blog?.status === true) {
                const blogData = {
                    ...blog.data, 
                    tags: Array.isArray(blog.data.tags) ? blog.data.tags.join(',') : ''
                };
                  
                setInitialValues(blogData);
                    ...
                    <div className="card mb-3">
                        <div className="card-header">
                            <div className="row flex-between-end">
                                <div className="col-auto align-self-center">
                                    <h5 className="mb-0" data-anchor="data-anchor">Edit Blog</h5>
                                </div>
                        ...
                        <div className='card-body'>
                            <MyForm errors={errors} fields={fields} initialValues={initialValues} validSchema={validationSchema} onSubmit={async (values) => {
                                ...
                                const data = await AxiosHelper.putData(`blog/edit/${values.id}`, values,true);
