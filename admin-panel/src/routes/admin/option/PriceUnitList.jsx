...
const PriceUnitList = () => {
  ...
  const getDataForTable = useCallback(async () => {
    const { data } = await AxiosHelper.getData("priceunit-datatable", param);
    if (data?.status === true) {
  ...
  return (
    <>
              ...
              <div className="row flex-between-end">
                <div className="col-auto align-self-center">
                  <h5 className="mb-0" data-anchor="data-anchor">
                    Manage Price Unit :: Price Unit List
                  </h5>
                </div>
                <div className="col-auto ms-auto">
                  <div className="mt-2" role="tablist">
                    ...
                    <PermissionBlock module={"PriceUnit"} action={"add"}>
                      <button
                        onClick={() => {
      ...
      >
        <Modal.Header>
          <Modal.Title>{ucFirst(formType)} Price Unit </Modal.Title>
          <CloseButton
