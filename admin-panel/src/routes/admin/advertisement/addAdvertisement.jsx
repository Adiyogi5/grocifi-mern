...
import { FILE_SIZE,SUPPORTED_FORMATS_IMAGE, DAYS } from '../../../constant/fromConfig';
import { Link, useNavigate } from 'react-router-dom';

import { fetchUsers, fetchCategories, fetchCountries, fetchStates, fetchCities,fetchConstant, fetchAdoption } from '../../../helper/ApiService';
...
const addAdvertisement = () => {
    ...
    const validationSchema = Yup.object().shape({
        ...
        price_type: Yup.number().required('Price Type is required'), 
    });

   
    const fetchData = useCallback(async () => {
        try {
            const [users, categories, countries, constants, options] = await Promise.all([
                fetchUsers(),
                fetchCategories(),
                fetchCountries(),
                fetchConstant(),
                    ...
                    <div className="card mb-3">
                        <div className="card-header">
                            <div className="row flex-between-end">
                                <div className="col-auto align-self-center">
                                    <h5 className="mb-0" data-anchor="data-anchor">Add Advertisement</h5>
                                </div>
                        ...
                        <div className='card-body'>
                            <MyForm errors={errors} fields={fields} initialValues={initialValues} validSchema={validationSchema} onSubmit={async (values) => {
                                ...
                                const data = await AxiosHelper.putData(`advertisement/add`, values,true);
