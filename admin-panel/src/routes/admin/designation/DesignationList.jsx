...
const DesignationList = () => {
  ...
  const getDataForTable = useCallback(async () => {
    const { data } = await AxiosHelper.getData("designation-datatable", param);
    if (data?.status === true) {
  ...
  const deleteData = async (event) => {
    ...
    if (isConfirmed) {
      ...
      var { data } = await AxiosHelper.deleteData(`delete-record/designations/${id}`);      
      if (data?.status === true) {
        getDataForTable();
  ...
  return (
    <>
              ...
              <div className="row flex-between-end">
                <div className="col-auto align-self-center">
                  <h5 className="mb-0" data-anchor="data-anchor">
                    Manage Designation :: Designation List
                  </h5>
                </div>
                <div className="col-auto ms-auto">
                  <div className="mt-2" role="tablist">
                    ...
                    <PermissionBlock module={"Designation"}>
                      <button
                        onClick={() => {
      ...
      >
        <Modal.Header>
          <Modal.Title>{ucFirst(formType)} Designation</Modal.Title>
          <CloseButton
        ...
        <Modal.Body>
          <MyFrom
            ...
            onSubmit={async (valuesData) => {
              ...
              var data = "";
              if (formType === "add") {
                data = await AxiosHelper.postData(
                  "designation/add",
                  valuesData
                );
              } else {
                data = await AxiosHelper.putData(
                  `designation/edit/${valuesData.id}`,
                  valuesData
                );
              }
        ...
        <Modal.Body>
          <ul className="list-group">
            <li className="list-group-item d-flex justify-content-between align-items-center">
              <label className="fs--1 m-0">Designation Name</label>
