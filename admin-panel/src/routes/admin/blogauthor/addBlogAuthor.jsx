...
import { fetchBusiness, fetchDesignation } from '../../../helper/ApiService';
...
const addBlogAuthor = () => {
    ...
    const fetchData = useCallback(async () => {
        try {
            const [ business, designation] = await Promise.all([
                fetchBusiness(),
                fetchDesignation(),
            ]);
                    ...
                    <div className="card mb-3">
                        <div className="card-header">
                            <div className="row flex-between-end">
                                <div className="col-auto align-self-center">
                                    <h5 className="mb-0" data-anchor="data-anchor">Add Blog Author</h5>
                                </div>
                        ...
                        <div className='card-body'>
                            <MyForm errors={errors} fields={fields} initialValues={initialValues} validSchema={validationSchema} onSubmit={async (values) => {
                                var data = "";
                                data = await AxiosHelper.postData("blogauthor/add", values, true);
