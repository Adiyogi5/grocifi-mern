      ...
      <div class="card card-default color-palette-bo">
        ...
        <div class="card-body">   
           <!-- For Messages -->
            ...
            <?php echo form_open_multipart(base_url($model.'/category/addcategory'), 'class="form-horizontal"  id="categoryForm"');  ?> 
              ...
              <div class="form-group row">   
                <div class="col-6">
                  ...
                  <select name="allow_upload" id="allow_upload" class="form-control">
                    ...
                    <option value="true" <?= (set_value('allow_upload') == 'true')?'selected': '' ?>>Allowed</option>
                    <option value="false" <?= (set_value('allow_upload') == 'false')?'selected': '' ?>>Not Allowed</option>
                  </select>
                </div>
                <div class="col-6">
                  ...
                  <select name="coming_soon" id="coming_soon" class="form-control">
                    <option value="">Select Option</option>
                    <option value="true" <?= (set_value('coming_soon') == 'true')?'selected': '' ?>>Yes</option>
                    <option value="false" <?= (set_value('coming_soon') == 'false')?'selected': '' ?>>No</option>
                  </select>
                </div>  
              </div>     
              <div class="form-group row">   
                <div class="col-sm-6">
                  ...
                  <input type="text" name="priority" class="form-control" id="priority" placeholder="" onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/[^\d\.]/g, '')" value="<?= set_value('priority'); ?>">
                </div>
                <div class="col-sm-6">
