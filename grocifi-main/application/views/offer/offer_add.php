      ...
      <div class="card card-default color-palette-bo">
        ...
        <div class="card-body">   
           <!-- For Messages -->
            ...
            <?php echo form_open_multipart(base_url($model.'/offer/add'), 'class="form-horizontal" id ="offerForm"');  ?> 
               ...
               <div class="form-group row">                   
                <div class="col-6">
                  ...
                  <select name="is_expiry" id="is_expiry" class="form-control">
                    ...
                    <option value="true" <?= (set_value('is_expiry') == '1')?'selected': '' ?>>Yes</option>
                    <option value="false" <?= (set_value('is_expiry') == '0')?'selected': '' ?>>Never</option>
                  </select>
                </div> 
                <div class="col-6">
                  ...
                  <select name="offer_type" id="offer_type" class="form-control">
                    ...
                    <option value="1" <?= (set_value('offer_type') == '1')?'selected': '' ?>>Offer</option>
                    <option value="2" <?= (set_value('offer_type') == '2')?'selected': '' ?>>Section</option>
                  </select>
                </div> 
              </div> 
