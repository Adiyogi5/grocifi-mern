    ...
    <div class="card">
      <div class="card-header">
        <div class="d-inline-block">
          <h3 class="card-title"><i class="fa fa-list"></i>&nbsp; Delivery Boy List </h3>
        </div>
        <div class="d-inline-block float-right">          
          <?php if($this->session->userdata('role_type')!='2' || (isset($this->general_user_premissions['user_delivery_boy']['is_add']) && $this->general_user_premissions['user_delivery_boy']['is_add']==1)){ ?> 
          <a href="<?= base_url($model.'/users/add/delivery_boy'); ?>" class="btn btn-success"><i class="fa fa-plus"></i> Add New Delivery Boy</a>
          <?php  } ?>
        </div>
...
<script>
  ...
  var table = $('#na_datatable').DataTable( {
    "processing": true,
    "serverSide": true,
    "ajax": "<?=base_url($model.'/users/delivery_boy_datatable_json')?>",
    "order": [[8,'desc']],
    "columnDefs": [
    ...
    { "targets": 4, "name": "rating", 'searchable':false, 'orderable':false}, 
    { "targets": 5, "name": "recived", 'searchable':false, 'orderable':false}, 
    { "targets": 6, "name": "deposit", 'searchable':false, 'orderable':false},
    { "targets": 7, "name": "diffAmt", 'searchable':false, 'orderable':false}, 
    { "targets": 8, "name": "created", 'searchable':false, 'orderable':true},
    { "targets": 9, "name": "is_active", 'searchable':true, 'orderable':false},
