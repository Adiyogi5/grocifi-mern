      ...
      <div class="card card-default color-palette-bo">
        ...
        <div class="card-body">   
           <!-- For Messages -->
            ...
            <?php echo form_open_multipart(base_url($model.'/coupon/add'), 'class="form-horizontal" id="couponForm"');  ?> 
              <div class="form-group row">                
                <div class="col-sm-6">
                <div class=" row">                  
                  <div class="col-sm-8">
                    <label for="title" class="col-sm-6 control-label">Coupon Code <span class="red">*</span></label><input type="text" name="title" class="form-control" id="title" placeholder="" value="<?= set_value('title'); ?>"></div>
                  <div class="col-sm-4">
                    <label for="title" class="col-sm-6 control-label">&nbsp;</label><button type="button" class="btn btn-primary generatecoupon">Generate Code</button></div>
                  </div>
                </div>
                 <div class="col-sm-6">
              ...
              <div class="form-group row">  
                <div class="col-6">
                  <label for="user_id" class="col-sm-6 control-label">User <span class="red">*</span></label> 
                   <input type="text" name="user_name" value="" placeholder="User Name" id="user_name" class="form-control" />
                ...
                <div class="col-6">
                  ...
                  <select name="has_expiry" id="has_expiry" class="form-control">
                    ...
                    <option value="true" <?= (set_value('has_expiry') == 'true')?'selected': '' ?>>Yes</option>
                    <option value="false" <?= (set_value('has_expiry') == 'false')?'selected': '' ?>>Yearly</option>
                  </select>
                </div>  
              </div> 
              ...
              <div class="form-group row selDate">                   
                <div class="col-6">
                  ...
                  <input type="date" name="start_date" class="form-control" id="start_date" placeholder="Enter start date of offer." value="<?= set_value('start_date'); ?>">
                </div>
                 <div class="col-6">
                  <label for="end_date" class="col-sm-6 control-label">End Date <span class="red">*</span></label>   
                  <input type="date" name="end_date" class="form-control" id="end_date" placeholder="Enter end date of Offer." value="<?= set_value('end_date'); ?>">
                </div>
              </div>
               ...
               <div class="form-group row">                   
                <div class="col-6">
                  ...
                  <select name="reuse_by_same_user" id="reuse_by_same_user" class="form-control">
                    <option value="">Select Option</option>
                    <option value="true" <?= (set_value('reuse_by_same_user') == 'true')?'selected': '' ?>>Yes</option>
                    <option value="false" <?= (set_value('reuse_by_same_user') == 'false')?'selected': '' ?>>No</option>
                  </select>
                </div>
                 <div class="col-6">
                  <label for="uses_number" class="col-sm-6 control-label">Number of uses <span class="red">*</span></label>   
                   <input type="text" name="uses_number" class="form-control" id="uses_number" placeholder="Enter maximum number of uses, (0 for unlimited)." value="<?= set_value('uses_number'); ?>">
                </div>
              </div>
               ...
               <div class="form-group row">                   
                <div class="col-6">
                  ...
                  <select name="disc_in" id="disc_in" class="form-control">
                    <option value="">Select Status</option>
                    <option value="1" <?= (set_value('disc_in') == '1')?'selected': '' ?>>Percentage</option>
                    <option value="2" <?= (set_value('disc_in') == '2')?'selected': '' ?>>Rupees</option>
                  </select>
                </div>
                 <div class="col-6">
                  <label for="disc_value" class="col-sm-6 control-label">Discount Value <span class="red">*</span></label>   
                  <input type="text" name="disc_value" class="form-control" id="disc_value" placeholder="Enter discount value" value="<?= set_value('disc_value'); ?>">
                </div>
              </div>

              <div class="form-group row">   
                <div class="col-6">
                  <label for="is_active" class="col-sm-12 control-label">Coupon Image <span class="red">*</span></label>     
              ...
              <div class="form-group">
                <div class="col-md-12">
                  <input type="submit" name="submit" value="Add Coupon" class="btn btn-info pull-right btn-submit ">
                </div>
              </div>
            <?php echo form_close( ); ?>
          <!-- /.box-body -->
  ...
  $(function () { 
    ...
    $("#couponForm").validate({
      ...
      messages: {
          ...
          coupon_image:{
                    required: "Please Select Coupon Image",
