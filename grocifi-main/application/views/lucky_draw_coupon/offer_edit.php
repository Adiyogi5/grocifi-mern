      ...
      <div class="card card-default color-palette-bo">
        ...
        <div class="card-body">   
           <!-- For Messages -->
            ...
            <?php echo form_open_multipart(base_url($model.'/lucky_draw_coupon/edit/'.$offer['_id']), 'class="form-horizontal" id="offerForm"');  ?> 
              ...
              <div class="form-group row">                   
               ...
               <div class="form-group row">                   
                ...
                <div class="col-6">
                 ...
                 <input type="number" name="offer_winner" class="form-control" id="offer_winner" placeholder="" value="<?= set_value('offer_winner', $offer['offer_winner']); ?>">
                </div> 
              </div>
              <div class="form-group row"> 
              <div class="col-6">
