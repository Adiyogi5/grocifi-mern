<?php $model = $this->session->userdata('model'); ?>
 <!-- Content Wrapper. Contains page content -->
      ...
      <div class="card card-default color-palette-bo">
        ...
        <div class="card-body">   
           <!-- For Messages -->
            ...
            <?php echo form_open(base_url($model.'/locations/addarea'), 'class="form-horizontal" id="areaForm"');  ?> 
              ...
              <div class="form-group">
                <div class="col-md-12">
                  <input type="submit" name="submit" value="Add Area" class="btn btn-info pull-right btn-submit">
                </div>
              </div>
            <?php echo form_close( ); ?>
          <!-- /.box-body -->
  ...
  $(document).ready(function(){     
    ...
    setTimeout(function(){ $("#cityId").val('<?= set_value('cityId'); ?>'); }, 1500);
