...
router.post('/update-profile', upload.single('image'), checkValid('updateProfile'), showValidationErrors, adminController.updateProfile);
router.post('/change-profile-image', upload.single('image') , adminController.changeProfileImage);
router.post('/change-password', checkValid('changePassword'), showValidationErrors, adminController.changePassword);
...
router.post('/subadmin/add', upload.single('image'), checkValid('addSubAdmin'), showValidationErrors, userManagementController.addSubAdmin);
router.get('/subadmin/edit/:id', userManagementController.getEditSubAdmin);
router.post('/subadmin/edit/:id', upload.single('image'), checkValid('updateSubAdmin'), showValidationErrors, userManagementController.updateSubAdmin);
router.delete('/subadmin/delete/:id', generalSettingsController.commonDelete);
router.post('/subadmin/delete-multiple', generalSettingsController.commonMultipleDelete);
router.delete('/subadmin/toggle-status/:id', generalSettingsController.toggleStatus);
...
router.post('/franchise/add', Storage.multiUpload.fields([
  { name: 'image', maxCount: 1 , dir: 'profile'},
  { name: 'logo', maxCount: 1, dir: 'franchise' }
]), checkValid('addFranchise'), showValidationErrors, userManagementController.addFranchise);
...
router.post('/franchise/edit/:id', Storage.multiUpload.fields([
  { name: 'image', maxCount: 1, dir: 'profile' },
  { name: 'logo', maxCount: 1, dir: 'franchise' }
]), checkValid('updateFranchise'), showValidationErrors, userManagementController.updateFranchise);
router.delete('/franchise/delete/:id', generalSettingsController.commonDelete);
router.post('/franchise/delete-multiple', generalSettingsController.commonMultipleDelete);
router.delete('/franchise/toggle-status/:id', generalSettingsController.toggleStatus);
...
router.post('/customer/add', upload.single('image'), checkValid('addCustomer'), showValidationErrors, userManagementController.addCustomer);
router.get('/customer/edit/:id', userManagementController.getEditCustomer);
router.post('/customer/edit/:id', upload.single('image'), checkValid('updateCustomer'), showValidationErrors, userManagementController.updateCustomer);
router.delete('/customer/delete/:id', generalSettingsController.commonDelete);
router.post('/customer/delete-multiple', generalSettingsController.commonMultipleDelete);
router.delete('/customer/toggle-status/:id', generalSettingsController.toggleStatus);
...
router.post('/wholesaler/add', Storage.multiUpload.fields([
  { name: 'img', maxCount: 1 , dir: 'profile'},
  { name: 'visiting_card', maxCount: 1, dir: 'visiting_card' }
]), checkValid('addWholesaler'), showValidationErrors, userManagementController.addWholesaler);
router.get('/wholesaler/edit/:id', userManagementController.getEditWholesaler);
router.post('/wholesaler/edit/:id', Storage.multiUpload.fields([
  { name: 'img', maxCount: 1 , dir: 'profile'},
  { name: 'visiting_card', maxCount: 1, dir: 'visiting_card' }
]), checkValid('updateWholesaler'), showValidationErrors, userManagementController.updateWholesaler);
router.delete('/wholesaler/delete/:id', generalSettingsController.commonDelete);
router.post('/wholesaler/delete-multiple', generalSettingsController.commonMultipleDelete);
router.delete('/wholesaler/toggle-status/:id', generalSettingsController.toggleStatus);
...
router.post('/delivery-boys/add', upload.single('image'), checkValid('addDeliveryBoy'), showValidationErrors, userManagementController.addDeliveryBoy);
router.get('/delivery-boys/edit/:id', userManagementController.getEditDeliveryBoy);
router.post('/delivery-boys/edit/:id', upload.single('image'), checkValid('updateDeliveryBoy'), showValidationErrors, userManagementController.updateDeliveryBoy);
router.delete('/delivery-boys/delete/:id', generalSettingsController.commonDelete);
router.post('/delivery-boys/delete-multiple', generalSettingsController.commonMultipleDelete);
router.delete('/delivery-boys/toggle-status/:id', generalSettingsController.toggleStatus);
