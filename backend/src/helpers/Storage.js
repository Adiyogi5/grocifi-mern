    ...
    constructor({ dir = 'admins', isImage = false, isDoc = false, fileSize = 2 }) {
        ...
        const fileFilter = (req, file, cb) => {
            ...
            if (isImage && SUPPORTED_FORMATS_DOC.includes(file.mimetype)) {
                req.fileValidationError = { [file.fieldname]: 'This document format is not allowed for images.' };
                return cb(null, false, new Error('This document format is not allowed for images.'));
            }
